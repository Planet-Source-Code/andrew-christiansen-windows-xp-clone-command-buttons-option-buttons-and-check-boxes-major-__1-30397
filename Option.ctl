VERSION 5.00
Begin VB.UserControl OptionButtonC 
   AutoRedraw      =   -1  'True
   ClientHeight    =   3600
   ClientLeft      =   0
   ClientTop       =   0
   ...
   End
End
Attribute VB_Name = "OptionButtonC"
